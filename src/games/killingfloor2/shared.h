...
// #define RENODX_PER_CHANNEL_HUE_CORRECTION 1.0f
// #define RENODX_PER_CHANNEL_CHROMINANCE_CORRECTION 1.0f
...
struct ShaderInjectData {
  ...
  float custom_filmgrain_multiplier;
  float seed;
  float custom_ssr_multiplier;
  float custom_aa;
  ...
  float custom_renodrt_tone_map_method;
};
...
#define CUSTOM_VIGNETTE_MULTIPLIER       shader_injection.custom_vignette_multiplier
#define CUSTOM_FILMGRAIN_MULTIPLIER      shader_injection.custom_filmgrain_multiplier
#define CUSTOM_IS_UI                     shader_injection.custom_is_ui
#define CUSTOM_LENS_MULTIPLIER           shader_injection.custom_lens_multiplier
#define SEED                             shader_injection.seed
#define CUSTOM_SSR_MULTIPLIER            shader_injection.custom_ssr_multiplier  
#define CUSTOM_AA                        shader_injection.custom_aa
#define CUSTOM_RENODRT_TONE_MAP_METHOD   shader_injection.custom_renodrt_tone_map_method
...
#define CUSTOM_PREEXP_MULTIPLIER shader_injection.custom_preexp_multiplier
#define CUSTOM_VANILLABLOWOUT shader_injection.custom_vanillablowout
