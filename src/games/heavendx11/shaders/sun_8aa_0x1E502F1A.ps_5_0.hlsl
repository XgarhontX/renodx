// ---- Created with 3Dmigoto v1.3.16 on Thu Mar 05 16:14:45 2026
...
Texture2DMS<float4,8> s_texture_0 : register(t0);
  ...
  out float3 o1 : SV_TARGET1)
{
  ...
  r1.z = min(r1.z, r1.y);
  r1.x = max(r1.x, r1.y);
  r2.xyz = s_texture_0.Load(r0.xy, 3).xyz;
  r1.y = 1.9921875 * r2.x;
  r1.y = floor(r1.y);
  r2.x = -r1.y * 0.501960814 + r2.x;
  r1.y = dot(r2.xyz, float3(1.9921875,0.00778198242,3.03983688e-005));
  ...
  r1.z = min(r1.z, r1.y);
  r1.x = max(r1.x, r1.y);
  r2.xyz = s_texture_0.Load(r0.xy, 4).xyz;
  r1.y = 1.9921875 * r2.x;
  r1.y = floor(r1.y);
  r2.x = -r1.y * 0.501960814 + r2.x;
  r1.y = dot(r2.xyz, float3(1.9921875,0.00778198242,3.03983688e-005));
  ...
  r1.z = min(r1.z, r1.y);
  r1.x = max(r1.x, r1.y);
  r2.xyz = s_texture_0.Load(r0.xy, 5).xyz;
  r1.y = 1.9921875 * r2.x;
  r1.y = floor(r1.y);
  r2.x = -r1.y * 0.501960814 + r2.x;
  r1.y = dot(r2.xyz, float3(1.9921875,0.00778198242,3.03983688e-005));
  ...
  r1.z = min(r1.z, r1.y);
  r1.x = max(r1.x, r1.y);
  r2.xyz = s_texture_0.Load(r0.xy, 6).xyz;
  r1.y = 1.9921875 * r2.x;
  r1.y = floor(r1.y);
  r2.x = -r1.y * 0.501960814 + r2.x;
  r1.y = dot(r2.xyz, float3(1.9921875,0.00778198242,3.03983688e-005));
  ...
  r1.z = min(r1.z, r1.y);
  r1.x = max(r1.x, r1.y);
  r0.xyz = s_texture_0.Load(r0.xy, 7).xyz;
  r0.w = 1.9921875 * r0.x;
  r0.w = floor(r0.w);
