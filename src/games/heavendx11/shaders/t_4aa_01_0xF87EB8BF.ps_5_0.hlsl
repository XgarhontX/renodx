// ---- Created with 3Dmigoto v1.3.16 on Thu Mar 05 15:46:09 2026
...
Texture2DMS<float4,4> s_texture_1 : register(t1);
Texture2DMS<float4,4> s_texture_3 : register(t3);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xy = (int2)r1.xy;
  r1.zw = float2(0,0);
  r2.xyz = s_texture_1.Load(r1.xy, 0).xyz;
  r1.xyzw = s_texture_3.Load(r1.xy, 0).xyzw;
  r1.xy = r1.xy + -r1.zw;
  r0.w = 1.9921875 * r2.x;
  r0.w = floor(r0.w);
  r2.x = -r0.w * 0.501960814 + r2.x;
  r0.w = dot(r2.xyz, float3(1.9921875,0.00778198242,3.03983688e-005));
  r0.w = 1 + -r0.w;
  r1.z = -r0.w * r0.w + near_blur_range.x;
  ...
  r0.w = exp2(r0.w);
  r1.z = near_blur_range.y * r1.z;
  r2.xy = r1.xy * v2.xy + v1.xy;
  r1.xy = v2.xy * r1.xy;
  r2.xy = s_viewport.xy * r2.xy;
  r2.xy = (int2)r2.xy;
  r2.zw = float2(0,0);
  r1.w = s_texture_3.Load(r2.xy, 0).w;
  r1.w = saturate(255 * r1.w);
  r1.xy = r1.xy * r1.ww + v1.xy;
  r2.xyzw = s_texture_6.Sample(s_sampler_6_s, r1.xy).xyzw;
  r1.xyw = s_texture_0.Sample(s_sampler_0_s, r1.xy).xyz;
  r1.z = max(r2.w, r1.z);
  r2.xyz = r2.xyz + -r1.xyw;
  r1.z = saturate(near_blur_range.w * r1.z);
  r1.z = log2(r1.z);
  r1.z = near_blur_range.z * r1.z;
  r1.z = exp2(r1.z);
  r2.w = r1.z + r0.w;
  r0.w = -r0.w * r1.z + r2.w;
