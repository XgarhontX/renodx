// ---- Created with 3Dmigoto v1.3.16 on Thu Mar 05 15:40:31 2026
...
cbuffer shader_material_textures_parameters : register(b1)
{
...
SamplerState s_sampler_3_s : register(s3);
...
Texture2D<float4> s_texture_3 : register(t3);
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyz = s_texture_10.Sample(s_sampler_10_s, v1.zw).xyz; T_LensDirt(r1.xyz);
  r0.xyz = r1.xyz * r0.xyz;
  r1.xyzw = s_texture_3.SampleLevel(s_sampler_3_s, v1.xy, 0).xyzw;
  r1.xy = r1.xy + -r1.zw;
  r1.zw = r1.xy * v2.xy + v1.xy;
  r1.xy = v2.xy * r1.xy;
  r0.w = s_texture_3.SampleLevel(s_sampler_3_s, r1.zw, 0).w;
  r0.w = saturate(255 * r0.w);
  r1.xy = r1.xy * r0.ww + v1.xy;
  r2.xyzw = s_texture_6.Sample(s_sampler_6_s, r1.xy).xyzw;
  r1.xyz = s_texture_0.Sample(s_sampler_0_s, r1.xy).xyz;
  r3.xyz = s_texture_1.SampleLevel(s_sampler_1_s, v1.xy, 0).xyz;
  r0.w = dot(r3.xyz, float3(1.9921875,0.00778198242,3.03983688e-005));
  r0.w = 1 + -r0.w;
  r1.w = -r0.w * r0.w + near_blur_range.x;
  r0.w = r0.w * r0.w + -far_blur_range.x;
  r0.w = far_blur_range.y * r0.w;
  r0.w = saturate(far_blur_range.w * r0.w);
  r0.w = log2(r0.w);
  r0.w = far_blur_range.z * r0.w;
  r0.w = exp2(r0.w);
  r1.w = near_blur_range.y * r1.w;
  r1.w = max(r1.w, r2.w);
  r2.xyz = r2.xyz + -r1.xyz;
  r1.w = saturate(near_blur_range.w * r1.w);
  r1.w = log2(r1.w);
  r1.w = near_blur_range.z * r1.w;
  r1.w = exp2(r1.w);
  r2.w = r1.w + r0.w;
  r0.w = -r0.w * r1.w + r2.w;
  r1.xyz = r0.www * r2.xyz + r1.xyz;
  r2.xyz = s_texture_8.Sample(s_sampler_8_s, v1.xy).xyz;
  r0.w = s_texture_7.Sample(s_sampler_7_s, float2(0.5,0.5)).x;
  r1.xyz = r1.xyz * r0.www + r2.xyz * shader_injection.bloom;
