// ---- Created with 3Dmigoto v1.3.16 on Sun Nov 09 21:39:43 2025
...
SamplerState ironsightsDofTextureSampler_s : register(s2);
Texture2D<float4> mainTexture : register(t0);
Texture2D<float4> tonemapBloomTexture : register(t1);
Texture2D<float4> ironsightsDofTexture : register(t2);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.zw = r0.xy * chromostereopsisParams.yy + v2.xy;
  r0.xy = -r0.xy * chromostereopsisParams.yy + v2.xy;
  r0.x = mainTexture.Sample(mainTextureSampler_s, r0.xy).z;
  r0.y = mainTexture.Sample(mainTextureSampler_s, r0.zw).y;
  r1.xyzw = ironsightsDofTexture.Sample(ironsightsDofTextureSampler_s, v2.xy).xyzw;
  r1.xyz = r1.xyz * r1.xyz;
  r1.xyz = ironsightsDofParams.yyy * r1.xyz;
  r0.z = ironsightsDofParams.x * r1.w;
  r0.w = -r1.w * ironsightsDofParams.x + 1;
  r1.xyz = r1.xyz * r0.zzz;
  r2.xyz = mainTexture.Sample(mainTextureSampler_s, v2.xy).xyz;
  r1.xyz = r2.xyz * r0.www + r1.xyz;
  r0.xy = -r1.zy + r0.xy;
  r1.y = chromostereopsisParams.x * r0.y + r1.y;
