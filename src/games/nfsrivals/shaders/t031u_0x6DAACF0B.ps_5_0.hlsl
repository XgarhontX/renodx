// ---- Created with 3Dmigoto v1.3.16 on Sun Nov 09 21:38:44 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xy = r0.zw * chromostereopsisParams.yy + r0.xy;
  r0.zw = -r0.zw * chromostereopsisParams.yy + r0.xy;
  r0.z = mainTexture.Sample(mainTextureSampler_s, r0.zw).z;
  r0.w = mainTexture.Sample(mainTextureSampler_s, r1.xy).y;
...
Tonemap_BloomScale(r2.xyz);
  r3.xyzw = ironsightsDofTexture.Sample(ironsightsDofTextureSampler_s, v2.xy).xyzw;
  r3.xyz = r3.xyz * r3.xyz;
  r3.xyz = ironsightsDofParams.yyy * r3.xyz;
  r0.x = ironsightsDofParams.x * r3.w;
  r0.y = -r3.w * ironsightsDofParams.x + 1;
  r3.xyz = r3.xyz * r0.xxx;
  r1.xyz = r1.xyz * r0.yyy + r3.xyz;
  r0.x = -r1.y + r0.w;
  r1.y = chromostereopsisParams.x * r0.x + r1.y;
  r0.x = -r1.z + r0.z;
  r1.z = chromostereopsisParams.x * r0.x + r1.z;
  r0.xyz = r2.xyz * bloomScale.xyz + r1.xyz;
...
r0.xyz = Tonemap_Vignette(r0.xyz, vignetteScaleAndOffset, vignetteParams, v2);
  ...
  // r0.xyz = exp2(r0.xyz);
float3 colorU = r0.xyz; Tonemap_InvGamma(colorU, r0.xyz, invGamma);
