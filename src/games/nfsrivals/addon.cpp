...
renodx::utils::settings::Settings settings = {
    new renodx::utils::settings::Setting{
        ...
        .can_reset = false,
        .label = "Settings Mode",
        .labels = {"Heat 1", "Heat 10", "Getting Bullied Online"},
        .is_global = true,
    },
    new renodx::utils::settings::Setting{
    ...
    new renodx::utils::settings::Setting{
        ...
        .section = "Extra",
        .tooltip = "Film Grain from vanilla post processing.\nThis is really only used in special cases like the Tactical Visor.",
        .max = 200.f,
        .parse = [](float value) { return value * 0.01f; },
    },
    // new renodx::utils::settings::Setting{
    ...
    new renodx::utils::settings::Setting{
        .key = "custom_alttextrender",
        .binding = &shader_injection.custom_alttextrender,
        .default_value = 1.f,
        .label = "UI: Alt Text",
        .section = "Extra",
        .tooltip = "Alternative multiplier on text to mitigate broken blend type on updgraded render texture.\nSee which one you like, I guess.",
        .min = -1.0f,
        .max = 1.0f,
        .format = "%.2f",
    },
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX (Need for Speed Rivals)";
