// ---- Created with 3Dmigoto v1.3.16 on Tue Sep 30 09:40:09 2025
#include "./common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = (r0.x * CUSTOM_VIGNETTE) * r0.yzw + float3(1,1,1);
  ...
  // r1.xyz = exp2(r1.xyz);
  r1.xyz = pow(r1.xyz, invGamma.xyz);

  r0.xyz = r1.xyz * r0.xyz;
  colorU = r0.xyz; //there is no clamping anywhere.
