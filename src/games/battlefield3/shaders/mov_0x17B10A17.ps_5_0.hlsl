// ---- Created with 3Dmigoto v1.3.16 on Tue Sep 30 09:40:08 2025

#include "../shared.h"

SamplerState yTexture_s : register(s0);
SamplerState crTexture_s : register(s1);
SamplerState cbTexture_s : register(s2);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = 1;
  r1.y = crTexture.Sample(crTexture_s, v2.xy).x;
  r1.z = cbTexture.Sample(cbTexture_s, v2.xy).x;
  r1.x = yTexture.Sample(yTexture_s, v2.xy).x;
  r1.w = 1;
