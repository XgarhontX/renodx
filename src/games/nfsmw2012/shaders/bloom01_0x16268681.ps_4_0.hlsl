  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = SamplerSource.Sample(SamplerSource_s, v1.zw).xyzw; S(r0);
  r0.xyz = r0.www * r0.xyz;
  r0.xyz = float3(32,32,32) * r0.xyz;
  r1.xyzw = SamplerSource.Sample(SamplerSource_s, v1.xy).xyzw; S(r1);
  r1.xyz = r1.www * r1.xyz;
  r0.xyz = r1.xyz * float3(32,32,32) + r0.xyz;
  ...
  r1.xyz = r1.www * r1.xyz;
  r0.xyz = r1.xyz * float3(32,32,32) + r0.xyz;
  r0.xyz = float3(0.0078125,0.0078125,0.0078125) * r0.xyz; S(r0);
  r0.w = max(r0.x, r0.y);
