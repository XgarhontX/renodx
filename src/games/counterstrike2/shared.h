...
struct ShaderInjectData {
  ...
  float custom_bloom;
  float custom_brightnessoffset;

  float custom_ui_showversiontext;
  float custom_ui_healthbarmutliplier;
  float custom_1;
  float custom_2;
};
...
#define CUSTOM_BRIGHTNESSOFFSET              shader_injection.custom_brightnessoffset
#define CUSTOM_UI_SHOWVERSIONTEXT            shader_injection.custom_ui_showversiontext
#define CUSTOM_UI_HEALTHBARMUTLIPLIER        shader_injection.custom_ui_healthbarmutliplier
