// ---- Created with 3Dmigoto v1.3.16 on Thu Oct 02 18:12:58 2025
#include "./common.hlsl"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = t13.SampleLevel(s1_s, r0.xy, 0).xyz;
  r0.xyzw = t12.SampleLevel(s0_s, r0.zw, 0).xyzw;
  r1.w = max(r0.y, r0.z);
  r1.w = max(r1.w, r0.x);
  r1.w = 1 + -r1.w;
  r1.w = rcp(r1.w);
  ...
  r0.xyz = min(cb3[1].www, r0.xyz);
  r2.xyz = cb3[0].yyy * r0.xyz;
  r2.xyz = cb3[0].www * cb3[0].zzz + r2.xyz;
  r3.xy = cb3[1].xx * cb3[1].yz;
  r2.xyz = r0.xyz * r2.xyz + r3.xxx;
  r3.xzw = cb3[0].yyy * r0.xyz + cb3[0].zzz;
  r0.xyz = r0.xyz * r3.xzw + r3.yyy;
  r0.xyz = r2.xyz / r0.xyz;
  r0.w = cb3[1].y / cb3[1].z;
