...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        ...
        .group = "button-line-3",
        .tooltip = "For when PreExposure settings get overexposed, .\n\n"
                   "Levels effected:\n"
                   "- The Hornet's Nest\n"
                   "- Second Sun",
        .tint = 0x610512,
    ...
    new renodx::utils::settings::Setting{
        ...
        .group = "button-line-3",
        .tooltip = "For when the original tonemapper values are tuned to insane values, leading PreExposure settings to get underexposed.\n\n"
                   "Levels effected:\n"
    ...
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BULLET,
        .label = "Please read tooltips of \"PreExposure Fix Preset\" buttons above.",
        .section = "Read Me",
    },
    new renodx::utils::settings::Setting{
