...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    CustomShaderEntry(0x1504F5AB),  // ads 0
    CustomShaderEntry(0x1BF9505F),  // ads 1
    CustomShaderEntry(0x9E55946E),  // ads 2

    CustomShaderEntry(0x2006ADA4),  // ui blur bg

    CustomShaderEntry(0xD981F82B),  // tonemap a
    CustomShaderEntry(0x02A618A0),  // tonemap b
    CustomShaderEntry(0xA4860451),  // tonemap c
    CustomShaderEntry(0xC8C49F5D),  // tonemap d

    CustomShaderEntry(0x2085E3DE),  // ui pause blur
    CustomShaderEntry(0x69F5418B),  // ui main
    CustomShaderEntry(0xA176057B),  // ui pause title bg
    CustomShaderEntry(0x33E447A0),  // ui text generic
...
const std::unordered_map<std::string, float> PRESET_NEUTRAL = {
    {"ToneMapType", 3.f},
...
const std::unordered_map<std::string, float> PRESET_HALF = {
    {"ToneMapType", 3.f},
    {"ColorGradeExposure", 1.f},
    {"ColorGradeHighlights", 50.f},
    {"ColorGradeShadows", 50.f},
    {"ColorGradeSaturation", 50.f},
    {"ColorGradeHighlightSaturation", 49.f},
    {"ColorGradeBlowout", 1.f},
    {"ColorGradeFlare", 0.f},
    {"ColorGradeScene", 50.f},
};
...
const std::unordered_map<std::string, float> PRESET_PREEX_DEFAULT = {
    {"CustomPreExposureAutoMultiplier", FLT_MIN},
    {"CustomPreExposureFinal", FLT_MIN},
};

const std::unordered_map<std::string, float> PRESET_PREEX_FIXOVEREX = {
    {"CustomPreExposureAutoMultiplier", 0.13f},
    {"CustomPreExposureFinal", FLT_MIN},

};
const std::unordered_map<std::string, float> PRESET_PREEX_FIXUNDEREX = {
    {"CustomPreExposureAutoMultiplier", 1.f},
    {"CustomPreExposureFinal", 0.13f},
};
...
renodx::utils::settings::Settings settings = {
    ...
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BUTTON,
        .label = "Preset: Original",
        .group = "button-line-2",
        .tooltip = "(Same as Reset All) Map HDR luminance on the original colors. Suffers banding from using the original saturated and clipping colors.",
        .on_change = []() { ApplyPreset(settings, PRESET_NEUTRAL); },
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BUTTON,
        .label = "Preset: Half and Half",
        .group = "button-line-2",
        .tooltip = "(My Preferred) Half HDR and half SDR. Makes it look more like MW1R.\n"
                   "For those who thinks the original tonemap is like people playing CS:GO with Digital Vibrance.",
        .on_change = []() { ApplyPreset(settings, PRESET_HALF); },
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BUTTON,
        .label = "Preset: ACES",
        .group = "button-line-2",
        .tooltip = "Bypasses the original tonemapper, then mimicing the contrast and blowout of the original with ACES.",
        .on_change = []() { ApplyPreset(settings, PRESET_ACES); },
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BUTTON,
        .label = "PreExposure: Reset",
        .group = "button-line-3",
        .tooltip = "Reset the PreExposure Settings, works for 90% of levels.",
        .on_change = []() { ApplyPreset(settings, PRESET_PREEX_DEFAULT); },
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BUTTON,
        .label = "PreExposure: Fix Overexposed",
        .group = "button-line-3",
        .tooltip = "Fix for when PreExposure leads to overexposure.\n\n"
                   "Levels effected:\n"
                   "- The Hornet's Nest\n"
                   "- Second Sun (after outer space scene)",
        .tint = 0x610512,
        .on_change = []() { ApplyPreset(settings, PRESET_PREEX_FIXOVEREX); },
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BUTTON,
        .label = "PreExposure: Fix Underexposed",
        .group = "button-line-3",
        .tooltip = "Fix for when PreExposure leads to underexposure.\n\n"
                   "Levels effected:\n"
                   "- The Only Easy Day... Was Yesterday",
        .tint = 0x610512,
        .on_change = []() { ApplyPreset(settings, PRESET_PREEX_FIXUNDEREX); },
    },
    ...
    new renodx::utils::settings::Setting{
        ...
        .label = "Anti-Aliasing modes Filmic and T2x are broken.\n"
                 "Filmic only works if UI Brightness = Game Brightness\n"
                 "Fixing it (tex upgrade) breaks other more important shaders.\n"
    ...
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BULLET,
        .label = "Please read tooltips of \"Preset\" buttons above.",
        .section = "Read Me",
    },
    new renodx::utils::settings::Setting{
        .value_type = renodx::utils::settings::SettingValueType::BULLET,
        .label = "A few levels are under/overexposed. You will notice when it happens.\n"
                 "Tooltips of \"PreExposure Fix Preset\" buttons above list levels.",
        .section = "Read Me",
    },
    new renodx::utils::settings::Setting{
    ...
    // new renodx::utils::settings::Setting{
    //     .key = "CustomCompressorPower",
    //     .binding = &shader_injection.custom_compressor_power,
    //     .value_type = renodx::utils::settings::SettingValueType::FLOAT,
    //     .default_value = .50f,
    //     .label = "Compressor Power",
    //     .section = "Upgrade Tone Map",
    //     .tooltip = "When should the luminance compressor engage?",
    //     .min = 0.00f,
    //     .max = 2.00f,
    //     // .parse = [](float value) { return value * 0.01f; },
    //     .format = "%.2f",
    ...
    // },
    // new renodx::utils::settings::Setting{
    //     .key = "CustomCompressorTheshold",
    //     .binding = &shader_injection.custom_compressor_threshold,
    //     .value_type = renodx::utils::settings::SettingValueType::FLOAT,
    //     .default_value = 2.00f,
    ...
    //     // .parse = [](float value) { return value * 0.01f; },
    //     .format = "%.2f",
    //     .is_enabled = []() { return shader_injection.custom_compressor_power == 1; },
    //     .is_visible = []() { return current_settings_mode >= 2; },
    // },
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX (Call of Duty: Mordern Warfare 2 Remastered)";
  ...
  switch (fdw_reason) {
    case DLL_PROCESS_ATTACH:
      ...
      if (!initialized) {
        ...
        // renodx::mods::swapchain::swap_chain_upgrade_targets.push_back({ //If on, breaks videos.
