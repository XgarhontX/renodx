...
struct ShaderInjectData {
  ...
  // float custom_compressor_threshold;
  // float custom_compressor_power;
...
// #define CUSTOM_COMPRESSOR_THRESHOLD shader_injection.custom_compressor_threshold
// #define CUSTOM_COMPRESSOR_POWER     shader_injection.custom_compressor_power
