...
float4 main(float2 texcoord : TEXCOORD) : COLOR
{
	...
	r1 = tex2D(reducedAlphaTexture, texcoord);
	r0.xyz = r0.xyz * r1.w + r1.xyz;
	r1 = tex2D(lensEffectsTexture, texcoord);
	r0.xyz = r0.xyz * r1.w + r1.xyz;
	r1 = tex2D(bloomTexture, texcoord);
	r1.xyz = r1.xyz * r1.xyz;
	r0.xyz = r0.xyz * r0.xyz + r1.xyz;
	r1.x = log2(r0.x);
	r1.y = log2(r0.y);
	r1.z = log2(r0.z);
	r0.xyz = r1.xyz * g_vSettings1.y;
	r1.x = exp2(r0.x);
	r1.y = exp2(r0.y);
	r1.z = exp2(r0.z);
	r0.xyz = r1.xyz * 0.96875 + 0.015625;
	r0.w = 0;
	r0 = tex3Dlod(lookupTexture, r0);
	r1.xyz = r0.y * g_mColour[1].xyz;
	r0.xyw = r0.x * g_mColour[0].xyz + r1.xyz;
	r0.xyz = r0.z * g_mColour[2].xyz + r0.xyw;
	r0.xyz = r0.xyz + g_mColour[3].xyz;
	r0.w = dot(r0.xyz, g_vFilmGrain.xyz);
	r0.w = -r0.w + g_vFilmGrain.w;
	r1.xyz = r0.xyz * r0.w + g_vSettings2.z;
	...
	r1.x = dot(r1.x, r1.x) + 0;
	r1.x = r1.x * g_vSpecialFX.x;
	r0.w = -r0.w * r1.x + r1.x;
	r0.w = r0.w + 1;
	o.xyz = r0.w * r0.xyz;
	o.w = 1;
