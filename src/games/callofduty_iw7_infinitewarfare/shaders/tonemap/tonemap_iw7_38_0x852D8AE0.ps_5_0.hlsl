// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:44:28 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  r2.x = saturate(dot(r6.xyz, cb2[7].xyz));
  r2.y = saturate(dot(r6.xyz, cb2[8].xyz));
  r2.z = saturate(dot(r6.xyz, cb2[9].xyz));
  r2.xyz = log2(r2.xyz);
  ...
  if (r2.w != 0) {
    ...
    r3.xw = (int2)r1.yy + int2(1,2);
    r5.xyzw = t14.Load(r3.x).xyzw;
    r6.xyz = t14.Load(r3.w).xyz;
    ...
    if (r1.x != 0) {
      r1.x = (uint)cb2[14].w;
      r1.y = cb2[11].z * r5.z;
      r8.xyzw = r6.xxxx ? cb2[12].xyzw : cb2[13].xyzw;
      r8.xyzw = r8.xyzw * r5.zzzz;
      if (r0.w != 0) {
        r9.xyzw = cb2[17].xyzw * cb2[11].yyyy;
      ...
      if (r0.w != 0) {
        ...
        r7.xyzw = cb2[11].xxxx * r7.xyzw + r0.zzzz;
        r7.xyzw = cb2[22].xyzw * r7.xyzw;
    ...
    if (r0.z == 0) {
      r1.xz = cb2[1].yx * r3.yz;
      r3.xyzw = float4(12,12,12,12) * r1.zxzx;
