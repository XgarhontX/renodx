  ...
  out float o1 : SV_TARGET1)
{
  ...
  r0.z = cmp(asint(cb2[7].z) != 3);
  if (r0.z != 0) {
    r0.zw = asint(cb2[7].yw) & int2(1,1);
    if (r0.z != 0) {
      r2.xyz = t1.Sample(s1_s, r0.yx).xyz;
      r2.xyz = cb2[6].xxx * r2.xyz;
      r1.xyz = cb2[6].yyy * r1.xyz + r2.xyz;
    }
    switch (cb2[7].x) {
      case 1 :      r0.z = dot(float3(0.212599993,0.715200007,0.0722000003), r1.xyz);
      switch (cb2[7].z) {
        case 2 :        r2.x = log2(r0.z);
        r2.x = r2.x * 0.693147182 + 9.2103405;
        r2.x = max(0, r2.x);
        r2.x = 0.0492605828 * r2.x;
        r2.x = min(1, r2.x);
        r2.x = r2.x * 360 + 300;
        r2.x = 0.00278551527 * r2.x;
        r2.x = frac(r2.x);
        r2.y = 5.98333359 * r2.x;
        r2.y = floor(r2.y);
        r2.x = r2.x * 5.98333359 + -r2.y;
        r3.z = 1 + -r2.x;
        r4.y = 1 + -r3.z;
        r5.xyzw = cmp(r2.yyyy == float4(0,1,2,3));
        r2.x = cmp(r2.y == 4.000000);
        r3.xy = float2(1,0);
        r6.xy = r5.ww ? r3.yz : r4.yy;
        r2.x = (int)r2.x | (int)r5.w;
        r4.xz = float2(1,0);
        r6.z = 1;
        r2.yzw = r5.zzz ? r4.zxy : r6.xyz;
        r2.x = (int)r2.x | (int)r5.z;
        r2.yzw = r5.yyy ? r3.zxy : r2.yzw;
        r2.x = (int)r2.x | (int)r5.y;
        r2.yzw = r5.xxx ? r4.xyz : r2.yzw;
        r2.x = (int)r2.x | (int)r5.x;
        r1.xyz = r2.xxx ? r2.yzw : r3.xyz;
        break;
        case 3 :        break;
        default :
        r0.z = cb13[3].x * r0.z;
        r0.z = log2(r0.z);
        r2.xy = float2(5.97393131,7.97393131) + r0.zz;
        r0.z = (int)r2.x;
        r0.z = max(0, (int)r0.z);
        r0.z = min(6, (int)r0.z);
        r2.x = saturate(0.5 * r2.y);
        r2.x = r0.z ? 1 : r2.x;
        r1.xyz = icb[r0.z+0].xyz * r2.xxx;
        break;
      }
      break;
      default :
      ...
      r2.xw = r3.xy * r1.xx + r3.zw;
      r1.x = saturate(r2.x / r2.w);
      r3.xyzw = r2.yyyy ? cb13[2].xyzw : cb13[1].xyzw;
      r2.xy = r3.xy * r1.yy + r3.zw;
      r1.y = saturate(r2.x / r2.y);
      r2.xyzw = r2.zzzz ? cb13[2].xyzw : cb13[1].xyzw;
      r2.xy = r2.xy * r1.zz + r2.zw;
      r1.z = saturate(r2.x / r2.y);
      break;
    }
