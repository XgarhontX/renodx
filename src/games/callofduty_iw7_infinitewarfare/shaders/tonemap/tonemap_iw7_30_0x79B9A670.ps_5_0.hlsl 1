// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:44:21 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  r5.xyz = cb2[12].xxx * r5.xyz;
  r3.xyz = cb2[12].yyy * r3.xyz + r5.xyz;
  ...
  r3.x = saturate(dot(r6.xyz, cb2[9].xyz));
  r3.y = saturate(dot(r6.xyz, cb2[10].xyz));
  r3.z = saturate(dot(r6.xyz, cb2[11].xyz));
  r3.xyz = log2(r3.xyz);
  ...
  if (r1.y != 0) {
    r1.y = 8 * r0.x;
    r1.w = r0.y * 483 + r0.x;
    r3.w = 123.779999 * cb2[0].w;
    r3.w = frac(r3.w);
    r3.w = 12345.5996 * r3.w;
    r1.w = r1.w * 234.5 + r3.w;
    r3.w = floor(r1.w);
    r1.w = frac(r1.w);
    r5.x = 0.103100002 * r3.w;
    r5.x = frac(r5.x);
    ...
    r5.x = frac(r5.x);
    r3.w = 1 + r3.w;
    r3.w = 0.103100002 * r3.w;
    r3.w = frac(r3.w);
    r5.y = 19.1900005 + r3.w;
    r5.y = dot(r3.www, r5.yyy);
    r3.w = r5.y + r3.w;
    r5.y = r3.w + r3.w;
    r3.w = r5.y * r3.w;
    r3.w = frac(r3.w);
    ...
    r5.x = r5.x * r5.y;
    r1.w = r3.w * r1.w + r5.x;
    r3.w = cb2[5].z * 0.300000012 + 1;
    r5.xyz = r3.xyz * r3.www;
    r3.w = -0.699999988 + r1.x;
    r3.w = 4 * abs(r3.w);
    r3.w = min(1, r3.w);
    r3.w = 1 + -r3.w;
    ...
    r0.z = -r0.z * 0.75 + 1;
    r3.xyz = saturate(r1.xyw * r0.zzz);
  }
  if (r2.w != 0) {
    r0.zw = (int2)r0.ww & int2(2,8);
    r1.x = cmp((int)r0.z != 0);
    r1.yw = t5.Load(r4.yzw).xy;
    r1.yw = float2(255.5,255.100006) * r1.wy;
    r1.yw = (uint2)r1.yw;
    r1.y = (uint)r1.y << 11;
    bitmask.y = ((~(-1 << 8)) << 3) & 0xffffffff;  r1.y = (((uint)r1.w << 3) & bitmask.y) | ((uint)r1.y & ~bitmask.y);
    r2.xw = (int2)r1.yy + int2(1,2);
    r5.xyzw = t14.Load(r2.x).xyzw;
    r6.xyz = t14.Load(r2.w).xyz;
    r7.xyzw = t14.Load(r1.y).xyzw;
    r6.xyz = cmp(float3(0,0,0) < r6.xyz);
    r1.y = cmp(0 < r5.z);
    r1.x = r1.y ? r1.x : 0;
    if (r1.x != 0) {
      r1.x = (uint)cb2[16].w;
      r1.y = cb2[13].z * r5.z;
      r8.xyzw = r6.xxxx ? cb2[14].xyzw : cb2[15].xyzw;
      r8.xyzw = r8.xyzw * r5.zzzz;
      if (r0.w != 0) {
        r9.xyzw = cb2[19].xyzw * cb2[13].yyyy;
        r8.xyzw = r9.xyzw * r8.xyzw;
        r1.y = cb2[13].y * r1.y;
        r9.xyzw = cb2[21].xyzw;
        r10.xyzw = cb2[20].xyzw;
      } else {
        r9.xyzw = cb2[17].xyzw;
        r10.xyzw = cb2[18].xyzw;
      }
    } else {
      r0.z = r0.z ? 1 : r5.x;
      r1.w = r5.y * r0.z;
      r11.xyzw = r7.xyzw * r0.zzzz;
      r2.x = r0.w ? 1 : 0;
      r1.y = r6.y ? r2.x : r1.w;
      r1.x = (uint)cb2[13].w;
      if (r0.w != 0) {
        r1.y = r1.y * r5.w;
        r7.xyzw = r7.xyzw * r0.zzzz + -r0.zzzz;
        r7.xyzw = cb2[13].xxxx * r7.xyzw + r0.zzzz;
        r7.xyzw = cb2[24].xyzw * r7.xyzw;
        r11.xyzw = r7.xyzw * r5.wwww;
        r9.xyzw = cb2[26].xyzw;
        r10.xyzw = cb2[25].xyzw;
      } else {
        r9.xyzw = cb2[22].xyzw;
        r10.xyzw = cb2[23].xyzw;
      }
      r0.z = cb2[0].x + cb2[0].x;
      r0.z = r6.z ? r0.z : 1;
      r8.xyzw = r11.xyzw * r0.zzzz;
    }
    if (r1.x == 0) {
      r0.z = 0;
    } else {
      r5.xy = (int2)-r1.xx + (int2)r4.zy;
      r5.zw = r4.xw;
      r1.w = t6.Load(r5.zxw).x;
      r2.x = (uint)r1.w >> 4;
      r1.w = r1.z ? r2.x : r1.w;
      r1.w = (int)r1.w & 4;
      r1.w = cmp((int)r1.w != 0);
      r6.xy = (int2)r1.xx + (int2)r4.zy;
      r6.zw = r5.zw;
      r1.x = t6.Load(r6.zxw).x;
      r2.x = (uint)r1.x >> 4;
      r1.x = r1.z ? r2.x : r1.x;
      r1.x = (int)r1.x & 4;
      r1.x = cmp((int)r1.x != 0);
      r4.y = (uint)r5.y >> 1;
      r1.z = t6.Load(r4.yzw).x;
      r2.x = (int)r5.y & 1;
      r2.w = (uint)r1.z >> 4;
      r1.z = r2.x ? r2.w : r1.z;
      r1.z = (int)r1.z & 4;
    ...
    if (r0.z == 0) {
      r1.xz = cb2[1].yx * r2.yz;
      r2.xyzw = float4(12,12,12,12) * r1.zxzx;
      ...
      r1.zw = r2.yx * r1.zw;
      r1.zw = (uint2)r1.zw;
      r2.xy = cmp((int2)r1.wz == int2(0,0));
      r1.zw = (int2)r1.zw & int2(14,14);
      r0.z = (uint)r1.x;
      r1.xz = cmp((int2)r1.zw != int2(6,6));
      r1.xz = r1.xz ? r2.xy : 0;
      ...
      r1.xyzw = r2.xyzw * r1.yyyy;
      r8.xyzw = r1.xyzw * r8.xyzw;
    }
    r1.xyz = r8.xyz + -r3.xyz;
    r3.xyz = r8.www * r1.xyz + r3.xyz;
  }
