// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:45:09 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    r3.yw = cmp(asint(cb2[5].wz) == int2(3,2));
    r1.y = (int)r1.y | (int)r3.w;
    r1.y = r1.y ? r3.y : 0;
    if (r1.y != 0) {
      r1.y = 8 * r0.x;
      r0.x = r0.y * 483 + r0.x;
      r3.y = 123.779999 * cb2[0].w;
      r3.y = frac(r3.y);
      r3.y = 12345.5996 * r3.y;
      r0.x = r0.x * 234.5 + r3.y;
      r3.y = floor(r0.x);
      r0.x = frac(r0.x);
      r3.w = 0.103100002 * r3.y;
      r3.w = frac(r3.w);
      ...
      r3.w = r4.x * r3.w;
      r3.y = 1 + r3.y;
      r3.y = 0.103100002 * r3.y;
      r3.yw = frac(r3.yw);
      r4.x = 19.1900005 + r3.y;
      r4.x = dot(r3.yyy, r4.xxx);
      r3.y = r4.x + r3.y;
      r4.x = r3.y + r3.y;
      r3.y = r4.x * r3.y;
      r3.y = frac(r3.y);
