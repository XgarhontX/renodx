// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:44:10 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    if (r2.y != 0) {
      ...
      r6.xy = cb2[0].yx + r1.zw;
      r6.xy = r6.xy * float2(1024,1024) + float2(-512,-512);
      r6.zw = float2(0.554549694,0.308517009) * r6.yx;
      r6.zw = frac(r6.zw);
      r6.xy = r6.yx * r6.zw + r6.xy;
      r1.y = r6.x * r6.y;
      r1.y = frac(r1.y);
      r1.y = r1.y * 2 + -1;
      r1.y = r1.y * r0.w + 1;
