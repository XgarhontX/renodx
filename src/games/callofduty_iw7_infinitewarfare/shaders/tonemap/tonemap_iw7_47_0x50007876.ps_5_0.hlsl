  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r3.y != 0) {
    ...
    if (r1.w != 0) {
      r1.w = (uint)cb2[11].w;
      r3.w = cb2[8].z * r5.z;
      r7.xyzw = r4.xxxx ? cb2[9].xyzw : cb2[10].xyzw;
      ...
      if (r3.z != 0) {
        ...
        r6.xyzw = cb2[8].xxxx * r6.xyzw + r3.yyyy;
