// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:43:43 2025
#include "../common.hlsl"
  ...
  out float o1 : SV_TARGET1)
{
  ...
  r0.w = r1.z ? r2.w : r0.w;
  r2.w = (int)r0.w & 4;
  r5.xyz = t3.Sample(s3_s, r0.xy).xyz; Tonemap_BloomScale(r5.xyz);
  ...
  if (r2.w != 0) {
    ...
    if (r0.z == 0) {
      ...
      r2.xyzw = r0.xyzw * r2.xyzw;
    }
    r0.xyz = r2.xyz + -r5.xyz;
    r5.xyz = r2.www * r0.xyz + r5.xyz;
  }
  ...
  //o0.xyz = DrawBinary(2, o0.xyz, v1.xy);
  return;
}