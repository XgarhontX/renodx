// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:43:03 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r2.w != 0) {
    ...
    r1.xw = t14.Load(r1.x).yw;
    r2.xw = t14.Load(r1.y).yz;
    r5.xyzw = t14.Load(r0.w).xyzw;
    r2.xw = cmp(float2(0,0) < r2.xw);
    r0.w = r0.z ? 1 : 0;
    r0.w = r2.x ? r0.w : r1.x;
    r1.x = (uint)cb2[13].w;
    if (r0.z != 0) {
      ...
      r6.xyzw = cb2[13].xxxx * r6.xyzw + float4(1,1,1,1);
      r6.xyzw = cb2[16].xyzw * r6.xyzw;
      r5.xyzw = r6.xyzw * r1.wwww;
      r6.xyzw = cb2[18].xyzw;
      r7.xyzw = cb2[17].xyzw;
    } else {
      r6.xyzw = cb2[14].xyzw;
    ...
    if (r1.x == 0) {
      ...
      r8.xy = (int2)-r1.xx + (int2)r4.zy;
      r8.zw = r4.xw;
      r1.w = t6.Load(r8.zxw).x;
      r2.x = (uint)r1.w >> 4;
      r1.w = r1.z ? r2.x : r1.w;
      r1.w = (int)r1.w & 4;
      r1.w = cmp((int)r1.w != 0);
    ...
    if (r1.y == 0) {
      r1.xy = cb2[1].yx * r2.yz;
      r2.xyzw = float4(12,12,12,12) * r1.yxyx;
