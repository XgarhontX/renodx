// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:45:25 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    r0.w = r2.y ? r2.z : r0.w;
    r2.y = (int)r0.w & 2;
    r2.zw = asint(cb2[13].yw) & int2(1,1);
    if (r2.z != 0) {
    ...
    switch (cb2[13].x) {
      ...
      switch (cb2[13].z) {
        ...
        r2.z = cb13[3].x * r2.z;
        r2.z = log2(r2.z);
        r5.xy = float2(5.97393131,7.97393131) + r2.zz;
        r2.z = (int)r5.x;
        r2.z = max(0, (int)r2.z);
        r2.z = min(6, (int)r2.z);
        r4.x = saturate(0.5 * r5.y);
        r4.x = r2.z ? 1 : r4.x;
        r3.xyz = icb[r2.z+0].xyz * r4.xxx;
        break;
      }
      break;
      default :
    ...
    r2.z = (int)r6.y | (int)r6.x;
    r2.z = (int)r6.z | (int)r2.z;
    ...
    r3.xyz = t5.SampleLevel(s5_s, r5.xyz, 0).xyz;
