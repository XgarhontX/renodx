// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:43:33 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r1.z != 0) {
    ...
    if (r1.z != 0) {
      ...
      r2.w = cmp(0 < cb2[7].w);
      if (r2.w != 0) {
        r5.xy = cb2[8].xy * float2(0.5,0.5) + float2(0.5,0.5);
      ...
      if (r1.z != 0) {
        ...
        if (r0.w != 0) {
          ...
          r2.yz = float2(1,1) + -cb2[7].xz;
          r0.w = cmp(0 < cb2[7].w);
          if (r0.w != 0) {
            r4.xy = cb2[8].xy * float2(0.5,0.5) + float2(0.5,0.5);
            r6.xy = cb2[1].xy * cb2[1].wz;
            r6.z = 1;
            r4.zw = r6.zy * r4.xy;
  ...
  r3.xyz = t5.SampleLevel(s5_s, r3.xyz, 0).xyz;
  ...
  if (r1.y != 0) {
    ...
    r1.w = frac(r1.w);
    r4.x = 19.1900005 + r1.w;
    r4.x = dot(r1.www, r4.xxx);
    r1.w = r4.x + r1.w;
    r4.x = r1.w + r1.w;
    r1.w = r4.x * r1.w;
    r1.w = frac(r1.w);
  ...
  if (r1.z != 0) {
    ...
    r2.x = (int)r2.x;
    r2.x = -1.06529242e+009 + r2.x;
    r0.w = r0.w * r2.x + 1.06529242e+009;
    r0.w = (int)r0.w;
    r0.w = saturate(r0.w);
    r0.xyz = -r1.xyz + r0.xyz;
    r0.xyz = r0.www * r0.xyz + r1.xyz;
    r1.xy = cb2[0].ww * r2.yz;
    r1.xy = frac(r1.xy);
    r1.xy = r1.xy * float2(1024,1024) + float2(-512,-512);
    r2.xy = float2(0.554549694,0.308517009) * r1.yx;
    r2.xy = frac(r2.xy);
    r1.xy = r1.yx * r2.xy + r1.xy;
    r0.w = r1.x * r1.y;
    r0.w = frac(r0.w);
    r0.w = r0.w * 2 + -1;
    r0.w = r0.w * r1.w + 1;
