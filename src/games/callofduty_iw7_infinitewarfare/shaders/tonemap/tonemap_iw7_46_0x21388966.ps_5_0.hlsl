// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:43:24 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.z != 0) {
    r0.zw = asint(cb2[8].yw) & int2(1,1);
    if (r0.z != 0) {
      r0.xyz = t1.Sample(s1_s, r0.xy).xyz;
      r0.xyz = cb2[7].xxx * r0.xyz;
      r2.xyz = cb2[7].yyy * r2.xyz + r0.xyz;
    }
    switch (cb2[8].x) {
      ...
      break;
      default :
      r0.xyz = cmp(r2.xyz < cb13[0].xxx);
      r1.xyzw = r0.xxxx ? cb13[2].xyzw : cb13[1].xyzw;
      r1.xy = r1.xy * r2.xx + r1.zw;
      r2.x = saturate(r1.x / r1.y);
      r1.xyzw = r0.yyyy ? cb13[2].xyzw : cb13[1].xyzw;
      r0.xy = r1.xy * r2.yy + r1.zw;
      r2.y = saturate(r0.x / r0.y);
      r1.xyzw = r0.zzzz ? cb13[2].xyzw : cb13[1].xyzw;
      r0.xy = r1.xy * r2.zz + r1.zw;
    ...
    r1.xyz = cmp(float3(0.998039186,0.998039186,0.998039186) < r0.xyz);
    r3.xyz = cmp(r0.xyz < float3(0.00196078443,0.00196078443,0.00196078443));
    r1.w = (int)r1.y | (int)r1.x;
    r1.w = (int)r1.z | (int)r1.w;
    ...
    r2.xyz = t2.SampleLevel(s2_s, r0.xyz, 0).xyz;
