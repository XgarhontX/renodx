  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r3.y != 0) {
    r3.yz = (int2)r2.ww & int2(2,8);
    r2.w = cmp((int)r3.y != 0);
    r4.xy = t3.Load(r1.yzw).xy;
    ...
    if (r2.w != 0) {
      r2.w = (uint)cb2[14].w;
      r3.w = cb2[11].z * r5.z;
      r7.xyzw = r4.xxxx ? cb2[12].xyzw : cb2[13].xyzw;
      r7.xyzw = r7.xyzw * r5.zzzz;
      if (r3.z != 0) {
        r8.xyzw = cb2[17].xyzw * cb2[11].yyyy;
      ...
      if (r3.z != 0) {
        ...
        r6.xyzw = cb2[11].xxxx * r6.xyzw + r3.yyyy;
        r6.xyzw = cb2[22].xyzw * r6.xyzw;
    ...
    if (r2.w == 0) {
      ...
      r4.x = (int)r4.x & 4;
      r4.x = cmp((int)r4.x != 0);
      r5.xy = (int2)r1.zy + (int2)r2.ww;
      r5.zw = r4.zw;
      r2.w = t4.Load(r5.zxw).x;
      r4.z = (uint)r2.w >> 4;
      r2.w = r3.x ? r4.z : r2.w;
      r2.w = (int)r2.w & 4;
      r2.w = cmp((int)r2.w != 0);
    ...
    if (r3.y == 0) {
      ...
      r0.z = cmp((int)r0.z != 0);
      r0.z = r3.z ? r0.w : r0.z;
      r1.xyzw = r0.zzzz ? r9.xyzw : r8.xyzw;
      r1.xyzw = r3.wwww * r1.xyzw;
      r7.xyzw = r1.xyzw * r7.xyzw;
    }
    r1.xyz = r7.xyz + -r2.xyz;
    r2.xyz = r7.www * r1.xyz + r2.xyz;
  }
