  ...
  out float o1 : SV_TARGET1)
{
  ...
  r5.xyz = cb2[9].xxx * r5.xyz;
  r2.xyz = cb2[9].yyy * r2.xyz + r5.xyz;
  ...
  r2.x = saturate(dot(r6.xyz, cb2[6].xyz));
  r2.y = saturate(dot(r6.xyz, cb2[7].xyz));
  r2.z = saturate(dot(r6.xyz, cb2[8].xyz));
  r2.xyz = log2(r2.xyz);
  ...
  r5.xyz = t4.SampleLevel(s4_s, r2.xyz, 0).xyz;
  r2.x = cmp(asint(cb2[4].z) == 2);
  ...
  if (r1.y != 0) {
    ...
    r1.w = floor(r0.x);
    r0.x = frac(r0.x);
    r2.x = 0.103100002 * r1.w;
    r2.x = frac(r2.x);
    r2.y = 19.1900005 + r2.x;
    r2.y = dot(r2.xxx, r2.yyy);
    r2.x = r2.x + r2.y;
    r2.y = r2.x + r2.x;
    r2.x = r2.y * r2.x;
    r2.x = frac(r2.x);
    ...
    r1.w = frac(r1.w);
    r2.y = 19.1900005 + r1.w;
    r2.y = dot(r1.www, r2.yyy);
    r1.w = r2.y + r1.w;
    r2.y = r1.w + r1.w;
    r1.w = r2.y * r1.w;
    r1.w = frac(r1.w);
    ...
    r1.w = r1.w * r0.x;
    r1.x = cmp(0 < r1.x);
    r2.xyz = r1.xxx ? r1.www : r2.xyz;
    r0.x = -0.5 + r0.x;
    r0.x = dot(r0.xx, r0.zz);
    r2.xyz = saturate(r2.xyz + r0.xxx);
    r0.x = r0.y * 2 + r1.y;
    ...
    r1.xyw = r0.yyy + -r2.xyz;
    r0.xyz = r0.xxx * r1.xyw + r2.xyz;
    r1.x = frac(r3.x);
    r1.x = -r1.x * 2 + 1;
  ...
  if (r2.w != 0) {
    ...
    r2.xyzw = t14.Load(r1.x).xyzw;
    r1.xyw = t14.Load(r1.y).xyz;
    r6.xyzw = t14.Load(r0.w).xyzw;
    r1.xyw = cmp(float3(0,0,0) < r1.xyw);
    r0.w = cmp(0 < r2.z);
    r0.z = r0.w ? r0.z : 0;
    if (r0.z != 0) {
      r0.z = (uint)cb2[13].w;
      r0.w = cb2[10].z * r2.z;
      r7.xyzw = r1.xxxx ? cb2[11].xyzw : cb2[12].xyzw;
      r7.xyzw = r7.xyzw * r2.zzzz;
      if (r0.y != 0) {
    ...
    if (r0.z == 0) {
      ...
      r2.xy = (int2)-r0.zz + (int2)r4.zy;
      r2.zw = r4.xw;
      r1.x = t6.Load(r2.zxw).x;
      r1.y = (uint)r1.x >> 4;
      r1.x = r1.z ? r1.y : r1.x;
      r1.x = (int)r1.x & 4;
      r1.x = cmp((int)r1.x != 0);
      r6.xy = (int2)r0.zz + (int2)r4.zy;
      r6.zw = r2.zw;
      r0.z = t6.Load(r6.zxw).x;
      r1.y = (uint)r0.z >> 4;
      r0.z = r1.z ? r1.y : r0.z;
      r0.z = (int)r0.z & 4;
      r0.z = cmp((int)r0.z != 0);
