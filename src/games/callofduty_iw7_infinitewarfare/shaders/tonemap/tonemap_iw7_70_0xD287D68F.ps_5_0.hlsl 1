// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:45:22 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  r3.xyz = cb2[9].xxx * r3.xyz;
  r1.xyz = cb2[9].yyy * r1.xyz + r3.xyz;
  ...
  r1.x = saturate(dot(r4.xyz, cb2[6].xyz));
  r1.y = saturate(dot(r4.xyz, cb2[7].xyz));
  r1.z = saturate(dot(r4.xyz, cb2[8].xyz));
  r1.xyz = log2(r1.xyz);
