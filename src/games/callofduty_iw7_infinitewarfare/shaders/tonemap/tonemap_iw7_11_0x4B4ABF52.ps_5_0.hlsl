  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    if (r2.z != 0) {
      ...
      r1.x = cmp((int)r0.z != 0);
      r2.xz = t4.Load(r4.yzw).xy;
      r2.xz = float2(255.5,255.100006) * r2.zx;
      r2.xz = (uint2)r2.xz;
      r1.y = (uint)r2.x << 11;
      bitmask.y = ((~(-1 << 8)) << 3) & 0xffffffff;  r1.y = (((uint)r2.z << 3) & bitmask.y) | ((uint)r1.y & ~bitmask.y);
      r2.xz = (int2)r1.yy + int2(1,2);
      r6.xyzw = t14.Load(r2.x).xyzw;
      r2.xzw = t14.Load(r2.z).xyz;
      r7.xyzw = t14.Load(r1.y).xyzw;
      r2.xzw = cmp(float3(0,0,0) < r2.xzw);
      r1.y = cmp(0 < r6.z);
      r1.x = r1.y ? r1.x : 0;
      if (r1.x != 0) {
        r1.x = (uint)cb2[16].w;
        r1.y = cb2[13].z * r6.z;
        r8.xyzw = r2.xxxx ? cb2[14].xyzw : cb2[15].xyzw;
      ...
      if (r1.x == 0) {
        ...
        r6.zw = r4.xw;
        r2.x = t5.Load(r6.zxw).x;
        r2.z = (uint)r2.x >> 4;
        r2.x = r2.y ? r2.z : r2.x;
        r2.x = (int)r2.x & 4;
        r2.x = cmp((int)r2.x != 0);
        r7.xy = (int2)r1.xx + (int2)r4.zy;
        r7.zw = r6.zw;
        r1.x = t5.Load(r7.zxw).x;
        r2.z = (uint)r1.x >> 4;
        r1.x = r2.y ? r2.z : r1.x;
        r1.x = (int)r1.x & 4;
        r1.x = cmp((int)r1.x != 0);
        r4.y = (uint)r6.y >> 1;
        r2.y = t5.Load(r4.yzw).x;
        r2.z = (int)r6.y & 1;
        r2.w = (uint)r2.y >> 4;
        r2.y = r2.z ? r2.w : r2.y;
        r2.y = (int)r2.y & 4;
