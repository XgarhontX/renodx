// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:45:20 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r1.z != 0) {
    ...
    r3.x = (int)r3.x;
    r3.x = -1.06529242e+009 + r3.x;
    r0.w = r0.w * r3.x + 1.06529242e+009;
    r0.w = (int)r0.w;
    r0.w = saturate(r0.w);
    r0.xyz = -r1.xyz + r0.xyz;
    r0.xyz = r0.www * r0.xyz + r1.xyz;
    r1.xy = cb2[0].ww * r3.yz;
    r1.xy = frac(r1.xy);
