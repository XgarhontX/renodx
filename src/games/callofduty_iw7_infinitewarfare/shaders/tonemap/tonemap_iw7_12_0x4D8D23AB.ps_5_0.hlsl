// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:43:51 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.z != 0) {
    ...
    r3.x = saturate(dot(r1.xyz, cb2[5].xyz));
    r3.y = saturate(dot(r1.xyz, cb2[6].xyz));
    r3.z = saturate(dot(r1.xyz, cb2[7].xyz));
    r3.xyz = log2(r3.xyz);
    r3.xyz = float3(0.416666657,0.416666657,0.416666657) * r3.xyz;
    r3.xyz = exp2(r3.xyz);
    r3.xyz = r3.xyz * float3(1.05499995,1.05499995,1.05499995) + float3(-0.0549999997,-0.0549999997,-0.0549999997);
    r3.xyz = max(float3(0,0,0), r3.xyz);
    r2.x = asint(cb2[8].w) & 1;
    ...
    r1.xyz = t2.SampleLevel(s2_s, r3.xyz, 0).xyz;
    if (r0.w != 0) {
