// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:45:38 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    switch (cb2[12].x) {
      ...
      switch (cb2[12].z) {
        case 2 :        r2.w = log2(r2.y);
        r2.w = r2.w * 0.693147182 + 9.2103405;
        r2.w = max(0, r2.w);
        r2.w = 0.0492605828 * r2.w;
        r2.w = min(1, r2.w);
        r2.w = r2.w * 360 + 300;
        r2.w = 0.00278551527 * r2.w;
        r2.w = frac(r2.w);
        r4.x = 5.98333359 * r2.w;
        r4.x = floor(r4.x);
        r2.w = r2.w * 5.98333359 + -r4.x;
        r5.z = 1 + -r2.w;
        r6.y = 1 + -r5.z;
        r7.xyzw = cmp(r4.xxxx == float4(0,1,2,3));
        r2.w = cmp(r4.x == 4.000000);
        r5.xy = float2(1,0);
        r8.xy = r7.ww ? r5.yz : r6.yy;
        r2.w = (int)r2.w | (int)r7.w;
        r6.xz = float2(1,0);
        r8.z = 1;
        r8.xyz = r7.zzz ? r6.zxy : r8.xyz;
        r2.w = (int)r2.w | (int)r7.z;
        r8.xyz = r7.yyy ? r5.zxy : r8.xyz;
        r2.w = (int)r2.w | (int)r7.y;
        r6.xyz = r7.xxx ? r6.xyz : r8.xyz;
        r2.w = (int)r2.w | (int)r7.x;
        r3.xyz = r2.www ? r6.xyz : r5.xyz;
        break;
        case 3 :        break;
        default :
        r2.y = cb13[3].x * r2.y;
        r2.y = log2(r2.y);
        r2.yw = float2(5.97393131,7.97393131) + r2.yy;
        r2.y = (int)r2.y;
        r2.y = max(0, (int)r2.y);
        r2.y = min(6, (int)r2.y);
        r2.w = saturate(0.5 * r2.w);
        r2.w = r2.y ? 1 : r2.w;
        r3.xyz = icb[r2.y+0].xyz * r2.www;
        break;
      }
      break;
      default :
      ...
      r2.yw = r6.xy * r3.xx + r6.zw;
      r3.x = saturate(r2.y / r2.w);
      r6.xyzw = r5.yyyy ? cb13[2].xyzw : cb13[1].xyzw;
      r2.yw = r6.xy * r3.yy + r6.zw;
      r3.y = saturate(r2.y / r2.w);
      r5.xyzw = r5.zzzz ? cb13[2].xyzw : cb13[1].xyzw;
      r2.yw = r5.xy * r3.zz + r5.zw;
      r3.z = saturate(r2.y / r2.w);
      break;
    }
    r5.x = saturate(dot(r3.xyz, cb2[9].xyz));
    r5.y = saturate(dot(r3.xyz, cb2[10].xyz));
    r5.z = saturate(dot(r3.xyz, cb2[11].xyz));
    r5.xyz = log2(r5.xyz);
    ...
    r5.xyz = t4.SampleLevel(s4_s, r5.xyz, 0).xyz;
    ...
    if (r1.y != 0) {
      r1.y = 8 * r0.x;
      r0.x = r0.y * 483 + r0.x;
      r2.y = 123.779999 * cb2[0].w;
      r2.y = frac(r2.y);
      r2.y = 12345.5996 * r2.y;
      r0.x = r0.x * 234.5 + r2.y;
      r2.y = floor(r0.x);
      r0.x = frac(r0.x);
      r2.w = 0.103100002 * r2.y;
      r2.w = frac(r2.w);
      ...
      r2.w = r4.x * r2.w;
      r2.y = 1 + r2.y;
      r2.y = 0.103100002 * r2.y;
      r2.yw = frac(r2.yw);
      r4.x = 19.1900005 + r2.y;
      r4.x = dot(r2.yyy, r4.xxx);
      r2.y = r4.x + r2.y;
      r4.x = r2.y + r2.y;
      r2.y = r4.x * r2.y;
      r2.y = frac(r2.y);
      ...
      r2.w = r4.x * r2.w;
      r0.x = r2.y * r0.x + r2.w;
      r2.y = cb2[6].z * 0.300000012 + 1;
      r6.xyz = r5.xyz * r2.yyy;
      r2.y = -0.699999988 + r1.x;
      r2.y = 4 * abs(r2.y);
      r2.y = min(1, r2.y);
      r2.y = 1 + -r2.y;
      r2.w = cmp(r1.x >= 0.00100000005);
      r2.w = r2.w ? 1.000000 : 0;
      r2.y = r2.y * r2.w;
      r2.y = r2.y * r0.x;
      r1.x = cmp(0 < r1.x);
      r6.xyz = r1.xxx ? r2.yyy : r6.xyz;
      r0.x = -0.5 + r0.x;
      r0.x = dot(r0.xx, r0.zz);
      r6.xyz = saturate(r6.xyz + r0.xxx);
      r0.x = r0.y * 2 + r1.y;
      ...
      r0.y = dot(r6.xyz, float3(0.298999995,0.587000012,0.114));
      r7.xyz = r0.yyy + -r6.xyz;
      r0.xyz = r0.xxx * r7.xyz + r6.xyz;
      r1.x = frac(r2.x);
      r1.x = -r1.x * 2 + 1;
      r1.x = cb2[6].z * abs(r1.x);
      r1.x = -r1.x * 0.75 + 1;
      r5.xyz = saturate(r1.xxx * r0.xyz);
    }
    r0.xy = t5.Load(r4.yzw).xy;
    ...
    if (r0.y != 0) {
      ...
      r6.xy = abs(r4.zz) + -abs(r4.yx);
      r6.z = abs(r4.z) * 0.000250000012 + 2.32830644e-010;
      ...
      r0.w = cb2[13].y;
      r1.x = cb2[14].z;
      r1.y = dot(r5.xyz, float3(0.212599993,0.715200007,0.0722000003));
    }
    ...
    r2.xy = float2(0.554549694,0.308517009) * r1.zy;
    r2.xy = frac(r2.xy);
    r1.yz = r1.zy * r2.xy + r1.yz;
    r0.w = r1.y * r1.z;
    r0.w = frac(r0.w);
    r0.w = r0.w * 2 + -1;
    r0.w = r0.w * r1.x + 1;
