// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:44:54 2025
  ...
  if (r0.w != 0) {
    ...
    if (r2.z != 0) {
      ...
      if (r0.z != 0) {
        ...
        r7.xyzw = cb2[13].xxxx * r7.xyzw + float4(1,1,1,1);
        r7.xyzw = cb2[16].xyzw * r7.xyzw;
        r6.xyzw = r7.xyzw * r2.zzzz;
        r7.xyzw = cb2[18].xyzw;
        r8.xyzw = cb2[17].xyzw;
      } else {
        r7.xyzw = cb2[14].xyzw;
