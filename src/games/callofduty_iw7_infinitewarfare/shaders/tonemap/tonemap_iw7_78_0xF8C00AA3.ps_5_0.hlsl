// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:45:46 2025
  ...
  if (r0.z != 0) {
    ...
    if (r3.z != 0) {
      ...
      if (r3.w != 0) {
        r3.w = (uint)cb2[14].w;
        r4.w = cb2[11].z * r6.z;
        r8.xyzw = r5.xxxx ? cb2[12].xyzw : cb2[13].xyzw;
        ...
        if (r3.z != 0) {
          ...
          r7.xyzw = cb2[11].xxxx * r7.xyzw + r3.xxxx;
      ...
      if (r3.x == 0) {
        ...
        r0.z = cmp((int)r0.z != 0);
        r0.z = r3.z ? r0.w : r0.z;
        r1.xyzw = r0.zzzz ? r10.xyzw : r9.xyzw;
        r1.xyzw = r4.wwww * r1.xyzw;
        r8.xyzw = r1.xyzw * r8.xyzw;
      }
      r1.xyz = r8.xyz + -r4.xyz;
      r4.xyz = r8.www * r1.xyz + r4.xyz;
    }
