// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:44:41 2025
  ...
  if (r0.z != 0) {
    switch (cb2[9].x) {
      ...
      switch (cb2[9].z) {
        ...
        r0.w = frac(r0.w);
        r1.x = 5.98333359 * r0.w;
        r1.x = floor(r1.x);
        r0.w = r0.w * 5.98333359 + -r1.x;
        r3.z = 1 + -r0.w;
        r4.y = 1 + -r3.z;
        r5.xyzw = cmp(r1.xxxx == float4(0,1,2,3));
        r0.w = cmp(r1.x == 4.000000);
        r3.xy = float2(1,0);
        r1.xy = r5.ww ? r3.yz : r4.yy;
        r0.w = (int)r0.w | (int)r5.w;
        r4.xz = float2(1,0);
        r1.z = 1;
        r1.xyz = r5.zzz ? r4.zxy : r1.xyz;
        r0.w = (int)r0.w | (int)r5.z;
        r1.xyz = r5.yyy ? r3.zxy : r1.xyz;
        r0.w = (int)r0.w | (int)r5.y;
        r1.xyz = r5.xxx ? r4.xyz : r1.xyz;
        r0.w = (int)r0.w | (int)r5.x;
        r2.xyz = r0.www ? r1.xyz : r3.xyz;
        break;
        case 3 :        break;
        default :
        r0.z = cb13[3].x * r0.z;
      ...
      r0.zw = r3.xy * r2.xx + r3.zw;
      r2.x = saturate(r0.z / r0.w);
      r3.xyzw = r1.yyyy ? cb13[2].xyzw : cb13[1].xyzw;
      r0.zw = r3.xy * r2.yy + r3.zw;
      r2.y = saturate(r0.z / r0.w);
      r1.xyzw = r1.zzzz ? cb13[2].xyzw : cb13[1].xyzw;
      r0.zw = r1.xy * r2.zz + r1.zw;
      r2.z = saturate(r0.z / r0.w);
      break;
    }
