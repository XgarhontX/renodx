// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:45:05 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    r2.y = (int)r0.w & 2;
    switch (cb2[12].x) {
      case 1 :      r2.z = dot(float3(0.212599993,0.715200007,0.0722000003), r3.xyz);
      switch (cb2[12].z) {
        case 2 :        r2.w = log2(r2.z);
        ...
        r2.z = cb13[3].x * r2.z;
        r2.z = log2(r2.z);
        r2.zw = float2(5.97393131,7.97393131) + r2.zz;
        r2.z = (int)r2.z;
        r2.z = max(0, (int)r2.z);
        r2.z = min(6, (int)r2.z);
        r2.w = saturate(0.5 * r2.w);
        r2.w = r2.z ? 1 : r2.w;
        r3.xyz = icb[r2.z+0].xyz * r2.www;
        break;
      }
      break;
      default :
      ...
      r2.zw = r6.xy * r3.xx + r6.zw;
      r3.x = saturate(r2.z / r2.w);
      r6.xyzw = r5.yyyy ? cb13[2].xyzw : cb13[1].xyzw;
      r2.zw = r6.xy * r3.yy + r6.zw;
      r3.y = saturate(r2.z / r2.w);
      r5.xyzw = r5.zzzz ? cb13[2].xyzw : cb13[1].xyzw;
      r2.zw = r5.xy * r3.zz + r5.zw;
      r3.z = saturate(r2.z / r2.w);
      break;
    }
    ...
    r3.xyz = t4.SampleLevel(s4_s, r5.xyz, 0).xyz;
    r2.zw = cmp(asint(cb2[5].wz) == int2(3,2));
    r1.y = (int)r1.y | (int)r2.w;
    r1.y = r1.y ? r2.z : 0;
    if (r1.y != 0) {
      r1.y = 8 * r0.x;
      r0.x = r0.y * 483 + r0.x;
      r2.z = 123.779999 * cb2[0].w;
      r2.z = frac(r2.z);
      r2.z = 12345.5996 * r2.z;
      r0.x = r0.x * 234.5 + r2.z;
      r2.z = floor(r0.x);
      r0.x = frac(r0.x);
      r2.w = 0.103100002 * r2.z;
      r2.w = frac(r2.w);
      ...
      r2.w = r4.x * r2.w;
      r2.z = 1 + r2.z;
      r2.z = 0.103100002 * r2.z;
      r2.zw = frac(r2.zw);
      r4.x = 19.1900005 + r2.z;
      r4.x = dot(r2.zzz, r4.xxx);
      r2.z = r4.x + r2.z;
      r4.x = r2.z + r2.z;
      r2.z = r4.x * r2.z;
      r2.z = frac(r2.z);
      ...
      r2.w = r4.x * r2.w;
      r0.x = r2.z * r0.x + r2.w;
      r2.z = cb2[6].z * 0.300000012 + 1;
      r5.xyz = r3.xyz * r2.zzz;
      r2.z = -0.699999988 + r1.x;
      r2.z = 4 * abs(r2.z);
      r2.z = min(1, r2.z);
      r2.z = 1 + -r2.z;
