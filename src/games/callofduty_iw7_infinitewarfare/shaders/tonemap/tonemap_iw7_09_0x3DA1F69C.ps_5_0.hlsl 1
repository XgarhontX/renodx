// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:43:42 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    r0.w = cmp((int)r3.y != 0);
    r3.yw = asint(cb2[11].yw) & int2(1,1);
    if (r3.y != 0) {
    ...
    switch (cb2[11].x) {
      ...
      switch (cb2[11].z) {
        ...
        r3.y = cb13[3].x * r3.y;
        r3.y = log2(r3.y);
        r5.xy = float2(5.97393131,7.97393131) + r3.yy;
        r3.y = (int)r5.x;
        r3.y = max(0, (int)r3.y);
        r3.y = min(6, (int)r3.y);
        r4.x = saturate(0.5 * r5.y);
        r4.x = r3.y ? 1 : r4.x;
        r2.xyz = icb[r3.y+0].xyz * r4.xxx;
        break;
      }
      break;
      default :
    ...
    r3.y = (int)r6.y | (int)r6.x;
    r3.y = (int)r6.z | (int)r3.y;
