  ...
  out float o1 : SV_TARGET1)
{
  ...
  r3.x = saturate(dot(r6.xyz, cb2[10].xyz));
  r3.y = saturate(dot(r6.xyz, cb2[11].xyz));
  r3.z = saturate(dot(r6.xyz, cb2[12].xyz));
  r3.xyz = log2(r3.xyz);
  ...
  if (r1.z != 0) {
    ...
    if (r0.z != 0) {
      ...
      r0.z = cb2[14].x;
      r0.w = cb2[15].y;
      r5.xyz = t1.Gather(s1_s, r2.zy).xzw;
    ...
    r2.xw = cb2[0].yx + r2.yz;
    r2.xw = r2.xw * float2(1024,1024) + float2(-512,-512);
    r5.xy = float2(0.554549694,0.308517009) * r2.wx;
    r5.xy = frac(r5.xy);
    r2.xw = r2.wx * r5.xy + r2.xw;
    r2.x = r2.x * r2.w;
    r2.x = frac(r2.x);
    r2.x = r2.x * 2 + -1;
    r2.x = r2.x * r0.w + 1;
    ...
    r2.xy = cb2[0].ww * r2.yz;
    r2.xy = frac(r2.xy);
    r2.xy = r2.xy * float2(1024,1024) + float2(-512,-512);
    r2.zw = float2(0.554549694,0.308517009) * r2.yx;
    r2.zw = frac(r2.zw);
    r2.xy = r2.yx * r2.zw + r2.xy;
    r0.z = r2.x * r2.y;
    r0.z = frac(r0.z);
    r0.z = r0.z * 2 + -1;
    r0.z = r0.z * r0.w + 1;
    r3.xyz = saturate(r1.xyz * r0.zzz);
  }
