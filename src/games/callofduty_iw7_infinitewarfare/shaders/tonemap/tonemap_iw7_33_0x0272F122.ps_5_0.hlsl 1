// ---- Created with 3Dmigoto v1.3.16 on Wed Aug 20 15:43:05 2025
  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    if (r3.z != 0) {
      ...
      r1.x = cmp((int)r0.z != 0);
      r3.xz = t4.Load(r4.yzw).xy;
      r3.xz = float2(255.5,255.100006) * r3.zx;
      r3.xz = (uint2)r3.xz;
      r1.y = (uint)r3.x << 11;
      bitmask.y = ((~(-1 << 8)) << 3) & 0xffffffff;  r1.y = (((uint)r3.z << 3) & bitmask.y) | ((uint)r1.y & ~bitmask.y);
      r3.xz = (int2)r1.yy + int2(1,2);
      r6.xyzw = t14.Load(r3.x).xyzw;
      r3.xzw = t14.Load(r3.z).xyz;
      r7.xyzw = t14.Load(r1.y).xyzw;
      r3.xzw = cmp(float3(0,0,0) < r3.xzw);
      r1.y = cmp(0 < r6.z);
      r1.x = r1.y ? r1.x : 0;
      if (r1.x != 0) {
        r1.x = (uint)cb2[14].w;
        r1.y = cb2[11].z * r6.z;
        r8.xyzw = r3.xxxx ? cb2[12].xyzw : cb2[13].xyzw;
