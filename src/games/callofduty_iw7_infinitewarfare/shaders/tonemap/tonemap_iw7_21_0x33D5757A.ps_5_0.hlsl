  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.w != 0) {
    ...
    r5.x = saturate(dot(r2.xyz, cb2[6].xyz));
    r5.y = saturate(dot(r2.xyz, cb2[7].xyz));
    r5.z = saturate(dot(r2.xyz, cb2[8].xyz));
    r5.xyz = log2(r5.xyz);
    ...
    r2.xyz = t3.SampleLevel(s3_s, r5.xyz, 0).xyz;
    ...
    if (r3.z != 0) {
      ...
      if (r0.z != 0) {
        r0.z = (uint)cb2[13].w;
        r0.w = cb2[10].z * r5.z;
        r7.xyzw = r3.xxxx ? cb2[11].xyzw : cb2[12].xyzw;
      ...
      if (r0.z == 0) {
        ...
        r5.xy = (int2)-r0.zz + (int2)r4.zy;
        r5.zw = r4.xw;
        r1.x = t5.Load(r5.zxw).x;
        r1.y = (uint)r1.x >> 4;
        r1.x = r3.y ? r1.y : r1.x;
        r1.x = (int)r1.x & 4;
        r1.x = cmp((int)r1.x != 0);
