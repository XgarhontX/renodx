  ...
  if (r0.w != 0) {
    ...
    switch (cb2[11].x) {
      ...
      switch (cb2[11].z) {
        ...
        r3.z = cb13[3].x * r3.z;
        r3.z = log2(r3.z);
        r3.zw = float2(5.97393131,7.97393131) + r3.zz;
        r3.z = (int)r3.z;
        r3.z = max(0, (int)r3.z);
        r3.z = min(6, (int)r3.z);
        r3.w = saturate(0.5 * r3.w);
        r3.w = r3.z ? 1 : r3.w;
        r2.xyz = icb[r3.z+0].xyz * r3.www;
        break;
      }
      break;
      default :
      ...
      r3.zw = r6.xy * r2.xx + r6.zw;
      r2.x = saturate(r3.z / r3.w);
      r6.xyzw = r5.yyyy ? cb13[2].xyzw : cb13[1].xyzw;
      r3.zw = r6.xy * r2.yy + r6.zw;
      r2.y = saturate(r3.z / r3.w);
      r5.xyzw = r5.zzzz ? cb13[2].xyzw : cb13[1].xyzw;
      r3.zw = r5.xy * r2.zz + r5.zw;
      r2.z = saturate(r3.z / r3.w);
      break;
    }
    r5.x = saturate(dot(r2.xyz, cb2[8].xyz));
    r5.y = saturate(dot(r2.xyz, cb2[9].xyz));
    r5.z = saturate(dot(r2.xyz, cb2[10].xyz));
    r5.xyz = log2(r5.xyz);
    ...
    if (r1.y != 0) {
      ...
      r3.z = r3.z * 234.5 + r3.w;
      r3.w = floor(r3.z);
      r4.x = 0.103100002 * r3.w;
      r4.x = frac(r4.x);
      ...
      r3.zw = frac(r3.zw);
      r5.w = 19.1900005 + r3.w;
      r5.w = dot(r3.www, r5.www);
      r3.w = r5.w + r3.w;
      r5.w = r3.w + r3.w;
      r3.w = r5.w * r3.w;
      r3.w = frac(r3.w);
