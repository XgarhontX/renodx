  ...
  out float o1 : SV_TARGET1)
{
  ...
  if (r0.z != 0) {
    ...
    r1.xyz = t3.SampleLevel(s3_s, r3.yzw, 0).xyz;
    if (r3.x != 0) {
      r0.xy = (int2)r2.xx & int2(4,8);
      r0.x = cmp((int)r0.x != 0);
      ...
      r0.x = r0.x * r2.w + 1.06529242e+009;
      r0.x = (int)r0.x;
      r0.x = saturate(r0.x);
