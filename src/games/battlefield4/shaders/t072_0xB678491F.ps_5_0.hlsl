// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 06 12:11:32 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = tonemapBloomTexture.Sample(tonemapBloomTextureSampler_s, v2.xy).xyz; Tonemap_BloomScale(r1.xyz);
