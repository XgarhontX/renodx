// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 06 12:10:09 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = texture_Texture2.Sample(sampler0_s, v1.xy).xy;
  ...
  r0.xyz = float3(0.916000009,5.94999981,10) * r0.xyz;
