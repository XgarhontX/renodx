// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 06 12:11:14 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = ironsightsDofParams.yyy * r0.yzw;
  r1.x = ironsightsDofParams.x * r1.w;
  r1.y = -r1.w * ironsightsDofParams.x + 1;
  r0.yzw = r1.xxx * r0.yzw;
  r1.xzw = mainTexture.Sample(mainTextureSampler_s, v2.xy).xyz;
  r0.yzw = r1.xzw * r1.yyy + r0.yzw;
  r0.x = r0.x + -r0.y;
...
Tonemap_BloomScale(r1.xyz);
  r0.xyz = r1.xyz * bloomScale.xyz + r0.yzw;
  r0.xyz = colorScale.xyz * r0.xyz;

r0.xyz = Tonemap_Vignette(r0.xyz, 
vignetteParams, vignetteColor, v2);

float3 colorU = r0.xyz;
Tonemap_Vanilla(colorU, r0.xyz);

Tonemap_FilmGrain(r0.xyz, colorU, 
filmGrainTextureScaleAndOffset, filmGrainColorScale, filmGrainTextureSampler_s, filmGrainTexture, v2);
