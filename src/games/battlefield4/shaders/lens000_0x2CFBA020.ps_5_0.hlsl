// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 06 12:10:30 2025
...
Texture2D<float4> texture_Texture4 : register(t2);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = float2(0.400000006,1.10000002) * external_lensFlareCenterDist;
  ...
  r1.xyz = texture_Texture4.Sample(sampler0_s, r0.xw).xyz;
  r1.xyz = float3(0.644999981,0.83099997,0.949000001) * r1.xyz;
  r0.xw = r0.yz * r2.xx;
  r2.x = r0.z * r3.x + -r0.x;
  r2.y = r0.y * r3.x + r0.w;
  r0.xy = float2(0.5,0.5) + r2.xy;
  r0.xyz = texture_Texture3.Sample(sampler0_s, r0.xy).xyz;
  r0.xyz = r0.xyz * float3(0.338999987,0.782999992,1) + r1.xyz;
