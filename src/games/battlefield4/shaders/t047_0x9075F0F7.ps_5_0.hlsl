  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.zw = -chromostereopsisParams.yz + r1.xy;
  r2.xyz = tonemapBloomTexture.Sample(tonemapBloomTextureSampler_s, r1.xy).xyz; Tonemap_BloomScale(r2.xyz);
  r0.w = mainTexture.Sample(mainTextureSampler_s, r1.zw).z;
  r0.w = r0.w + -r0.z;
  r0.z = chromostereopsisParams.x * r0.w + r0.z;
  r0.xyz = r2.xyz * bloomScale.xyz + r0.xyz;
...
filmGrainTextureScaleAndOffset, filmGrainColorScale, filmGrainTextureSampler_s, filmGrainTexture, v2);
  ...
  o0.xyz = r0.xyz; o0.xyz = Tonemap_Do(colorU, o0.xyz, v2.xy, mainTexture);
  return;
}