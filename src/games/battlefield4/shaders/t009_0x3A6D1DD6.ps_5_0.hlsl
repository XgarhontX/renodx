// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 06 12:10:36 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.zw = -chromostereopsisParams.yz + r0.xy;
  r2.xyz = tonemapBloomTexture.Sample(tonemapBloomTextureSampler_s, r0.xy).xyz; Tonemap_BloomScale(r2.xyz);
