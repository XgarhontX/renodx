// ---- Created with 3Dmigoto v1.3.16 on Thu Nov 06 12:12:04 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.xyz = float3(2.41300011,1.93099999,1.477) * r1.xyz;
  r0.xw = r0.yz * r2.xx;
  r2.x = r0.z * r3.x + -r0.x;
  r2.y = r0.y * r3.x + r0.w;
  r0.xy = float2(0.5,0.5) + r2.xy;
  r0.xyz = texture_Texture2.Sample(sampler0_s, r0.xy).xyz;
  r0.xyz = r0.xyz * float3(12,11.9709997,9.65499973) + r1.xyz;
