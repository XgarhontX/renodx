...
float4 main(float2 texcoord: TEXCOORD) : COLOR {
  ...
  // o.xyz = (C_MOV > 0) ? renodx::draw::UpscaleVideoPass(o.xyz) : o.xyz; //sucks for drawn movies

  o.xyz = saturate(o.xyz);
  o.xyz = renodx::color::srgb::Decode(o.xyz); //TODO: srgb or gamma?
  o.xyz *= C_MOV / GRAPHICS_WHITE_NITS;
