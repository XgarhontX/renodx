...
float4 UniformVector_0          : register(c0);
float4 ScreenPositionScaleBias  : register(c1);
// c2 : def float4(0.5, 6.28318548, -3.14159274, 0.599999964)
// c3 : def float4(1.5, 1.25, 1, 0)

// --- Input ---
struct PS_INPUT
{
    float2 v0 : TEXCOORD0;
    float4 v1 : TEXCOORD4; // dcl_texcoord4_pp, only .w used
    float4 v2 : TEXCOORD5; // dcl_texcoord5 v2.xyw
};
...
PS_OUTPUT main(PS_INPUT i)
{
    ...
    // sincos r1.y, r0.x   (sincos dst_sin, dst_cos, src)
    //   -> r1.y = sin(r0.x)
    sincos(r0.x, r1.y, r0.z); // r0.z used as throwaway cos dest
    ...
    o.oC0.xyz = SunPass(o.oC0.xyz, Texture2D_0, i.v0.xy, i.v1.w);

    // mov_pp oC0.w, c3.w  (= 0.0)
    o.oC0.w = c3.w;
