...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    CustomShaderEntry(0x7CFCDF1A),  // tonemap 0
    CustomShaderEntry(0x6047C5DE),  // tonemap 1
    CustomShaderEntry(0x56443BE9),  // final present
    CustomShaderEntry(0x62D69253),  // mov
...
void OnInitSwapchain(reshade::api::swapchain* swapchain, bool resize) {
  ...
  // settings[8]->default_value = renodx::utils::swapchain::ComputeReferenceWhite(peak.value());
}
      ...
      if (!initialized) {
...

        {
          auto* setting = new renodx::utils::settings::Setting{
              ...
              .section = "Display Output",
              .labels = {"None (Untested)", "SRGB (Unsupported)", "2.2 (Unsupported)", "2.4 (Unsupported)", "HDR10", "scRGB (Preferred)"},
              .is_enabled = []() { return shader_injection.tone_map_type >= 1; },
        ...
        renodx::mods::swapchain::swap_chain_upgrade_targets.push_back({
            ...
            .ignore_size = true,  // bruh, idk why but it must be true to detect!
