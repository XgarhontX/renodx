  ...
  out float4 o0 : SV_Target0)
{
  ...
  //this is lut i think. its a strip green to red, idk wth. 2D ahh lut.
  ...
  r1.w = log2(abs(r1.y));
  r1.w = g_tone_offset.w * r1.w; //per shot gamma correct?
  r1.w = exp2(r1.w);
  ...
  r1.x = v3.y * r0.y;
  r1.y = 0;
  r1.xy = g_textures_2_.SampleLevel(g_samplers_2__s, r1.xy, 0).yx; //strip tonemap green to red
  r0.y = v3.x * r1.x;
  r1.xz = r0.yy * r0.xz;
  ...
  //tonemapped  
  Tonemap_Do(colorUntonemapped, r0.xyz, g_textures_0_);
