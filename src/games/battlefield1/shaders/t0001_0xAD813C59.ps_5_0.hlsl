// ---- Created with 3Dmigoto v1.3.16 on Tue Nov 11 00:51:11 2025
...
Tonemap_BloomScale(r0.xyw);
  r2.xyz = r0.xyw + -r1.xyz;
  r1.xyz = r0.zzz * r2.xyz + r1.xyz;
  r2.xyzw = ironsightsDofTexture.Sample(ironsightsDofTextureSampler_s, v2.xy).xyzw;
  r2.xyz = r2.xyz * r2.xyz;
  r2.xyz = ironsightsDofParams.yyy * r2.xyz;
  r0.z = ironsightsDofParams.x * r2.w;
  r1.w = -r2.w * ironsightsDofParams.x + 1;
