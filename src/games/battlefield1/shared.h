...
struct ShaderInjectData {
  ...
  float custom_vignette_multiplier;

  float custom_filmgrain_multiplier;
  float custom_filmgrain_multiplier_reno;
...
#define CUSTOM_FILMGRAIN_MULTIPLIER_RENO shader_injection.custom_filmgrain_multiplier_reno
